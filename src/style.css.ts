...
.maplibregl-versatiles-styler h3 {
	font-weight: bold;
	font-size: 1em;
	padding: 0 8px;
	margin: 4px 0 0;
...
.maplibregl-versatiles-styler .maplibregl-list button {
	background: none;
	border: none;
	cursor: pointer;
	display: block;
...
.maplibregl-versatiles-styler .maplibregl-list button.active {
	font-weight: bold;
}

.maplibregl-versatiles-styler .maplibregl-list button:hover {
	background-color: rgba(0, 0, 0, 0.05);
}

.maplibregl-versatiles-styler .maplibregl-list button+button {
	border-top: 1px solid #ddd;
}

.maplibregl-versatiles-styler button.maplibregl-ctrl-icon {
